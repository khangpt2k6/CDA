...
\noindent
Below are our answers for Lab~9 (questions 1--4).  We typed them up so they are easy to read,
and dropped in the Vivado schematic where the lab asked for a screenshot.
...
The counter in the lab instructions uses \textbf{synchronous, active-high} reset.  You can see it in the RTL:
...
\begin{lstlisting}[caption={Excerpt: synchronous active-high reset (from the lab counter code).}]
