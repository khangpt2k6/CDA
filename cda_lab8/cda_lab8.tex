...
$0\ldots 4$ with $D_{\text{MSB}}$ tied low on the SN7448 (same style as prior labs' decoder hookup),
...
\begin{itemize}
  ...
  \item SN7448 (or lab-equivalent BCD-to-7-segment IC) plus 7-segment display showing the
        encoded state $0\ldots 4$.
...
25\,cents events.  The breadboard was wired to match Figure~\ref{fig:schematic}.  If required,
add a separate photograph of the assembled hardware alongside that figure.
