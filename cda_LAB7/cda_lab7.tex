...
\begin{figure}[H]
\centering
\includegraphics[width=0.72\linewidth]{gray_counter.png}
\caption{Listing 1 -- Behavioral Verilog model for the 3-bit Gray code counter.}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.72\linewidth]{gray_counter_tb.png}
\caption{Listing 2 -- Testbench for the 3-bit Gray code counter.}
\end{figure}
